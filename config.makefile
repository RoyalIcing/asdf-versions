...
erlang_versions := 25.0.4
elixir_versions := 1.13.4-otp-25
gleam_versions := 0.22.1
nodejs_versions := 16.16.0 18.7.0
deno_versions := 1.24.3
bun_versions := 0.1.10
zig_versions := 0.9.1
rust_versions := 1.63.0
clojure_versions := 1.10.3.1087
redis_versions := 7.0.4
ruby_versions := 3.1.2
terraform_versions := 1.2.7
v_versions := 0.3
java_versions := adoptopenjdk-17.0.0+35
sbcl_versions := 2.2.5

ifeq ($(arch), arm64)
golang_versions := 1.19 1.18.4 1.17.8
python_versions := 3.10.6
opam_versions := 
swiprolog_versions :=
else
golang_versions := 1.19 1.18.4 1.17.8 1.13.15 1.14.11 1.12.10
